...
module AppendFooterFilter
  def append(post)
     ...
     post.content + %Q[<p class='post-footer'>
            &nbsp;#{pre or "原文地址："}
            <a target="_blank" href='#{post.full_url}'>#{post.full_url}</a><br/>
            &nbsp;版权声明：自由转载-非商用-非衍生-保持署名|
            <a target="_blank" href='http://creativecommons.org/licenses/by-nc-nd/3.0/deed.zh'>Creative Commons BY-NC-ND 3.0</a>
            </p>]
  end 
end
